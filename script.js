...
// Validações
if (isNaN(preco) || preco <= 0) throw new Error('Informe um preçoválido (> 0).');
...
const J_total = precoComDesconto * i * parcelas; // juros simplestotal
...
// Usa appendChild (mais compatível que append com múltiplosargs)
